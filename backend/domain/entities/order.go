...
type Order struct {
	...
	Quantity           int        `gorm:"column:quantity" json:"Quantity" binding:"required"`        //type:int       comment:訂購數量          version:2023-10-02
	ProductSinglePrice int        `gorm:"column:product_single_price" json:"ProductSinglePrice"`     //type:int       comment:單價              version:2023-10-02
